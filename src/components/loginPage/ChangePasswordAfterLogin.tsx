        ...
        <div className="absolute bottom-0"><img src={ellipse6} width={"400px"}></img></div>
          <div className="flex flex-col justify-center items-center h-full">
            ...
            <div className="flex justify-between mt-6 w-[350px] md:w-[450px]">
              <Link to={'/login'}>
            <button className="rounded-[50%] z-50 w-[45px] h-[45px] bg-blue_color text-white flex justify-center items-center cursor-pointer">
             <i className="fa-sharp fa-solid fa-arrow-left"></i>  
              </button>
              </Link>
             <Link to='#'><button className="bg-blue_color text-white px-8 py-3 rounded-md flex"><img src={signup_icon} className="mr-2"></img>Confirm</button></Link> 
            </div>
            </div> 
          </div>
    </div>
